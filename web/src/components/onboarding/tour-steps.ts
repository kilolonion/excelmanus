  ...
  return [
    {
      id: "basic", label: "对话与任务", steps: [
        ...
        { target: "coach-sidebar", title: "把文件带进任务", description: isMobile ? "点选文件即可引用；触屏无需拖拽。试试将示例文件加入下方任务。" : "可以拖拽工作区文件到输入框，也可以点选引用。试试添加下面的示例文件。", icon: "FolderOpen", placement: "right", onEnter: "openSidebar_files", practice: "file" },
    ...
    },
    {
      id: "advanced", label: "文件与表格", steps: [
        ...
        { target: "coach-sidebar", title: "查看表格与切换工作表", description: "点击工作区中的表格可以打开预览。试试在示例中切换 Sheet，再点选一个单元格。", icon: "Table2", placement: "right", onEnter: "openSidebar_files", practice: "sheet" },
        { target: "coach-sidebar", title: "检查修改与历史", description: "打开表格后，在功能区的历史入口查看版本和修改记录。下面可以比较同一单元格的前后值。", icon: "History", placement: "right", onEnter: "openSidebar_files", practice: "history" },
        { target: "coach-chat-input", title: "上传与多种文件", description: "输入框的附件入口支持表格、文档与图片。先选择一个示例类型，查看它适合怎样的任务。", icon: "Upload", placement: "top", onEnter: "showComposer", practice: "formats" },
      ],
    },
    {
      id: "settings", label: "模型与插件", steps: [
        ...
        { target: "coach-settings-content-model", title: "订阅与授权", description: "已有订阅时，可在订阅与 OAuth 中完成授权；API Key 在供应商页配置。授权流程可以稍后进行。", icon: "KeyRound", placement: "left", onEnter: "openSettings_subscription", practice: "subscription" },
        ...
        { target: "coach-settings-content-runtime", title: "按需调整系统设置", description: "上下文、压缩和其他运行参数在系统页管理。先用演示开关了解自动压缩，正式配置可保持默认。", icon: "SlidersHorizontal", placement: "left", onEnter: "openSettings_runtime", practice: "runtime" },
        { target: "coach-settings-content-version", title: "更新与重新查看引导", description: "这里可以查看版本。以后在“设置 → 系统 → 新手引导”选择任意章节重新体验。", icon: "ArrowUpCircle", placement: "left", onEnter: "openSettings_version" },
      ],
    },
  ];
}
