        ...
        <div className="border-t border-border pt-6">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <Field label="Client Secret" value={goDraft.client_secret} onChange={(v) => { setGoDraft((d) => ({ ...d, client_secret: v })); setGoDirty(true); }} placeholder="例如 GOCSPX-xxxxxxxxxxxxxxxx" secret />
