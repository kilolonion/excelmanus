...
export function WorkBuddyOAuthCard({
  ...
  const controller = useSubscriptionProvider(PROVIDER, profiles, { label: CARD_TITLE, base_url: REALM_BASE, protocol: "openai", thinking_mode: "auto", model_family: "" });
  const {
  ...
  const busy = loginBusy || controller.busy;
