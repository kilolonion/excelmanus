...
# Legacy normalization helper limits.  New durable attachments keep source
# bytes; these limits remain available to explicit conversion callers.
...
HIGH_REQUEST_IMAGE_PIXEL_MULTIPLIER = 4
REQUEST_IMAGE_TRANSFORM_VERSION = "request-image-v7-source-receipt"
