...
TOOL_DESCRIPTIONS: dict[str, str] = {
    "inspect_spreadsheet": (
        ...
        "返回 content_version。正文是投影预览，不是全表事实。"
    ),
    "analyze_spreadsheet": (
    ...
    "compare_spreadsheets": (
        ...
        "alignment=position 按行列，遇到增删行会对齐错。"
    ),
    ...
    "run_code": (
        "对可用工具执行一段程序。沙箱内 `em` 模块把本目录可见工具映射为同名 Python 函数，签名与 schema 一致。"
        "只把 print 或返回值当作程序输出。"
    ),
    "read_image": (
