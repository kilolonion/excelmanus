...
class SkillRouter:
    ...
    def _get_router_client(self) -> Any:
        ...
        if self._router_client is None:
            ...
            _aux_effective = self._config.aux_enabled and bool(self._config.aux_model)
            _router_protocol = self._config.aux_protocol if _aux_effective else self._config.protocol
