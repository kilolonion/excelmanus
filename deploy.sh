...
#
#  架构:
#    后端 API  → BACKEND_SERVER  (backend-host)
#    前端 Web  → FRONTEND_SERVER (frontend-host)
#
#  用法:  ./deploy.sh [选项]
#
#  选项:
...
BACKEND_SERVER="backend-host"
FRONTEND_SERVER="frontend-host"
SERVER_USER="root"

BACKEND_REMOTE_DIR="/opt/excelmanus"
FRONTEND_REMOTE_DIR="/opt/excelmanus"
